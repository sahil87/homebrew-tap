class FabKit < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "dc8f820e28742b3dc2c2e32dbf3b118ac16855ece7a5dfdc03420acefcad9b3e"
    end
    on_intel do
      url "https://github.com/sahil87/fab-kit/releases/download/v#{version}/brew-darwin-amd64.tar.gz"
      sha256 "bd545317758e6c4d7c0b0c76935077761c6e4bf05f009b250b3154962db2d398"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "ec4c9bf83cef0dace0e42390cee7a426efbeb507170645395459364c9ea4973b"
    end
    on_intel do
      url "https://github.com/sahil87/fab-kit/releases/download/v#{version}/brew-linux-amd64.tar.gz"
      sha256 "419c76db84ab5a98c4c9a91fc821eae0b79441b14f4a320f7b89a802ad9235af"
    end
  end
