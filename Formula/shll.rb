class Shll < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "355b25ef4ad2c9953d69987466a796dfbec64b60b0c3004c655218780f185041"
    end
    on_intel do
      url "https://github.com/sahil87/shll/releases/download/v#{version}/shll-darwin-amd64.tar.gz"
      sha256 "f70a7636a87f9890121db0a26feebe25f756a1635f7c5a192318a26b46b97174"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "fbde7bd00988dd422ce849c053afc4ad862eb872edf8237c2ae76128dc5e0f9a"
    end
    on_intel do
      url "https://github.com/sahil87/shll/releases/download/v#{version}/shll-linux-amd64.tar.gz"
      sha256 "c3f293aa9876905e680065764c0f7ed1d1ca039637046a6ec91296079c8c65b0"
    end
  end
