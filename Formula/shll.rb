class Shll < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "f39c93c35b4335ffd97c960717806b4aa27ec44e0ee8ce87d53fa8b92ac6d052"
    end
    on_intel do
      url "https://github.com/sahil87/shll/releases/download/v#{version}/shll-darwin-amd64.tar.gz"
      sha256 "e4e7536c05050f4953782af642810867a5bb37d1fea00bcc25c08fba2228dc59"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "6fc8a7db767092e1554a866e909bdc42a7fb7e992cad054fc4af669763de4f36"
    end
    on_intel do
      url "https://github.com/sahil87/shll/releases/download/v#{version}/shll-linux-amd64.tar.gz"
      sha256 "fae401513e9ccc4022b22d2f780a49f236cd9205f47586b3cd661f6f6821d1d9"
    end
  end
