class Shll < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "a9c239ec3bd11495b07a962fa6f237dc29139aa2be9fba1589572193614e6fd1"
    end
    on_intel do
      url "https://github.com/sahil87/shll/releases/download/v#{version}/shll-darwin-amd64.tar.gz"
      sha256 "fe63617e740a0442057c1e9663d2a6441d4b3754bb2ea6928fd1224b108b943b"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "d15c039866f99b95604fb9f0a42f48e8bd56cf10df431268a94ae87887e2c00d"
    end
    on_intel do
      url "https://github.com/sahil87/shll/releases/download/v#{version}/shll-linux-amd64.tar.gz"
      sha256 "a4291fde0d8bc0f746edf59040681315a1f46f3f3eb476fb0be5c55a9ac941bf"
    end
  end
