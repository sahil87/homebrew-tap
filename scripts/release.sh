...
#
# CI takes over from the tag push to recompute the tarball sha256 and
# update Formula/all.rb in this repo (see .github/workflows/release.yml).
#
...
echo ""
echo "Done — $new_tag pushed. CI will compute the tarball sha256 and update Formula/all.rb."
